...
## [1.29.0](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/compare/magento-log-viewer-v1.28.3...magento-log-viewer-v1.29.0) (2026-05-26)
...
* add confirmation popup for deleting all log files and update button visibility based on log file presence ([53d2950](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/53d29506db0f3a3500752cbc1e56d0c308c535c5))
...
* add option to group log entries by message content in workspace configuration ([cc7bfe9](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/cc7bfe9df5b6c0f110784a832f9467f328ffb662))
...
* add support for refreshing report files and update badge count in LogViewer ([df15c28](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/df15c283fd761120a4f647d852c11979aac179a4))
...
* add timestamp formatting for log entries ([d73ddaf](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/d73ddaf7ffa2e5c7b236d6a9422a8e70679faea3))
...
* Delete Reports, Github-Workflows, Release 1.7.0 ([d46bf61](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/d46bf6148576ddbb516a171f7d5d33fb0a9f49d8))
...
* refactor Magento project selection and improve button visibility logic ([8c37c5d](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/8c37c5d69c2220e5289f93259546f76282211429))
...
* sort log entries and message groups alphabetically in LogViewer ([874eff1](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/874eff14c5d114fbc50c311655c71864d5d69a7b))
...
* add missing types for node and mocha in tsconfig ([42f8b0c](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/42f8b0c6ef62d153b2cdce9400f7485e7689138f))
* add security for prompt Injection ([d91c567](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/d91c567cde069e974335df74157360a3bd0cfbf2))
...
* bump engines.vscode to ^1.115.0 to match @types/vscode ([#99](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/99)) ([1d30e68](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/1d30e683449de9081b3868c737a08c5cb2c07e2a))
...
* handle missing GitHub Copilot Chat installation error ([0376883](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/0376883bbcf342003351921c454fb39149a5d6e8))
* handle undefined currentVersion in update notification ([9a11a2a](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/9a11a2a7dc9f4726821f7c289ba8f7016910d45a))
...
* improve file path extraction ([5ae8ebb](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/5ae8ebbe5e9693fcb893e08627a1c32bda825461))
...
* remove package name from release configuration ([a152c9b](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/a152c9bd0838e8934f282c13718f887943fab4f3))
...
* set package name to 'Release' in release configuration ([aee39dd](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/aee39ddfd480e10175baebb99817d7a8ba7bff8c))
...
* update GitHub Actions workflow to set up Xvfb for testing ([b0433c3](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/b0433c396f3026ca0745be93ddeeb1f3eb35c3d5))
...
* add video to README for Magento Log Viewer extension ([4e87678](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/4e87678b2dd715a8f22011d339a2ef83b0def82d))
...
* update description for Magento Log Viewer extension ([d5e4c99](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/d5e4c9978f08da6eee6f33123f40a77b99186e13))


### Code Refactoring

* change parameter type from 'any' to 'unknown' in updateConfig function for better type safety ([8a631fe](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/8a631fec88881c83a7b69205573b48f119361721))
* extract functions for better readability and maintainability in extension.ts ([e46e229](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/e46e2297c4f3313630badc40f6c203f28cb535b2))
* extract functions for better readability and maintainability in extension.ts ([0544876](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/0544876053f2085a7a734c61b6a937b66a15bbee))
...
* streamline copilot instructions for clarity and conciseness ([fea292c](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/fea292c6f3a491daa141bb8d03b2dfecb1a3d8a8))
...
* bump version to 1.5.0 ([37989e8](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/37989e8ddae3bc4d403381ac13cb3d9e6a95a72b))
* **changelog:** update changelog for version 1.19.0 ([8d3de34](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/8d3de34b08d5e073c03f4caaf170dabfbb141265))
* **deps-dev:** bump @types/node from 20.19.27 to 25.0.3 ([#26](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/26)) ([9cd1b40](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/9cd1b4060e3b2c899ce32d260ab2a92c881ea8c1))
* **deps-dev:** bump @types/node from 25.0.10 to 25.2.2 ([#49](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/49)) ([1db3196](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/1db319662071a3768a8b84c96144327a537c6af5))
* **deps-dev:** bump @types/node from 25.0.3 to 25.0.6 ([#27](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/27)) ([e05cfec](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/e05cfec44ed7826671113fd2e213a08e93f0c26e))
...
* **deps-dev:** bump @types/node from 25.5.0 to 25.5.2 ([#85](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/85)) ([fd79dc5](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/fd79dc521c87c46fc44ba85305d0ffbb5540cec5))
* **deps-dev:** bump @types/node from 25.5.2 to 25.6.0 ([#94](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/94)) ([dbfb1b0](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/dbfb1b0b9447cea232da4d92cbf2cdac2abadebf))
...
* **deps-dev:** bump @types/vscode from 1.107.0 to 1.108.1 ([#28](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/28)) ([82ab6b7](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/82ab6b790519e05ee9bf98ea1b912dc80c29ff59))
...
* **deps-dev:** bump @types/vscode from 1.110.0 to 1.115.0 ([#91](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/91)) ([25c671d](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/25c671d1f113f46bd2bb2d0361ade4d5b2981788))
* **deps-dev:** bump @types/vscode from 1.115.0 to 1.116.0 ([#103](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/103)) ([5416a8d](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/5416a8ddf66f06533c51c76292b1705e8876b7e2))
...
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([#83](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/83)) ([753da1c](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/753da1ca0ca2196807a899ead88dec821608221a))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([#89](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/89)) ([aabc966](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/aabc966adf8f512674f669883ae1854117e970c1))
* **deps-dev:** bump @typescript-eslint/eslint-plugin ([#90](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/90)) ([02f8338](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/02f8338c3ea788ae3725bd71acdbd15ffece01b4))
...
* **deps-dev:** bump @typescript-eslint/parser from 8.57.1 to 8.57.2 ([#82](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/82)) ([8091649](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/8091649f3ea8a4a2cafe8d606ebdca508dcba188))
* **deps-dev:** bump @typescript-eslint/parser from 8.57.2 to 8.58.0 ([#88](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/88)) ([4b56930](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/4b56930ff6656ea3c155ef4fd43227c1af2aa0de))
...
* **deps-dev:** bump @vscode/test-cli from 0.0.10 to 0.0.12 ([#25](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/25)) ([45316c4](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/45316c45c25421da00caafd62ffa61a5cdd1b797))
* **deps-dev:** bump @vscode/test-cli from 0.0.10 to 0.0.12 ([#38](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/38)) ([e944d80](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/e944d80fba2ac60a7f96498a3836b29bcc64d5ba))
...
* **deps-dev:** bump eslint from 10.0.3 to 10.1.0 ([#80](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/80)) ([091216c](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/091216cb2b5ef77ec9c8f48cf1e0f0b9e38944e8))
* **deps-dev:** bump eslint from 10.1.0 to 10.2.0 ([#87](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/87)) ([cf3dd87](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/cf3dd872ff8cf1e1947ebbe7f89944bbcbef920f))
* **deps-dev:** bump eslint from 10.2.0 to 10.2.1 ([#102](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/102)) ([50b0018](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/50b0018302d0748bd548887ff87f690f64cef182))
...
* **deps-dev:** bump eslint from 9.39.2 to 10.0.0 ([#47](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/47)) ([a8c8b9c](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/a8c8b9cdcec2d1b4f8ed66651b20e969acd62f36))
...
* **deps-dev:** bump ts-loader from 9.5.4 to 9.5.7 ([#86](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/86)) ([ece120a](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/ece120a7ce5e6549a2713d836d770ecbfc48d3bc))
* **deps-dev:** bump typescript from 5.9.3 to 6.0.2 ([#84](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/84)) ([cb2249f](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/cb2249fa3788dc968e6ba0ac6dc6b7baed53100b))
* **deps-dev:** bump typescript from 6.0.2 to 6.0.3 ([#105](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/105)) ([3a3ffda](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/3a3ffdab04cba64f004aa493f3377c8bce619236))
...
* **deps-dev:** bump webpack from 5.105.4 to 5.106.1 ([#92](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/92)) ([249b294](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/249b29496c620684df143c6a7e50345773d92a9f))
* **deps-dev:** bump webpack from 5.106.1 to 5.106.2 ([#104](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/104)) ([2e70fc0](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/2e70fc084ee677a1dfb289c9ca59500fe2fd870f))
...
* **deps-dev:** bump webpack-cli from 5.1.4 to 6.0.1 ([#24](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/24)) ([8e199c6](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/8e199c6a86750995f8f78ffd38c35fe491ce9a2c))
...
* **deps:** bump the npm_and_yarn group across 1 directory with 1 update ([#81](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/81)) ([c0a1506](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/c0a150677072136cabed3bfbf1dd91a2c95a059b))
* **deps:** update dependencies to latest versions in package-lock.json ([1fb3627](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/1fb3627d192e32f754cb534cf438604638bf11fd))
* **deps:** Version auf 1.17.1 erhöht & package-lock.json regeneriert 🔒 ([83df85b](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/83df85b8900175b198bb3c5b835a1f92811cc566))
* **main:** release 1.28.1 ([#98](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/98)) ([10e7dc3](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/10e7dc395e0a69c31eb14e64b9a7fb9f5212b04a))
* **main:** release 1.28.2 ([#100](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/100)) ([494f703](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/494f703893bea6c4e7fc3446fa4e9c99898c3e90))
* **main:** release 1.28.3 ([#101](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/101)) ([834fc0f](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/834fc0f9f1e0e1a575d4db77446e424e388143a7))
* **main:** release magento-log-viewer 1.25.0 ([#32](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/32)) ([7bc7951](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/7bc795133dc4aecdb8e829fe4d52b02c3b8c2f0a))
* **main:** release magento-log-viewer 1.25.1 ([#34](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/34)) ([ed55a9c](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/ed55a9c878dbe1385b0f56dcf81c8546d7a0b4c3))
* **main:** release magento-log-viewer 1.25.2 ([#40](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/40)) ([bbf2583](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/bbf25838df451e1c6d0e0692155ba9fb8fc282ac))
* **main:** release magento-log-viewer 1.25.3 ([#50](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/50)) ([5ed0933](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/5ed09337b0541e91920f41474e780dac22c3cebc))
* **main:** release magento-log-viewer 1.25.4 ([#51](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/51)) ([515e42d](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/515e42db07d59d5dce4759576fd2bd524152ae7e))
* **main:** release magento-log-viewer 1.26.0 ([#52](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/52)) ([2df3f8d](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/2df3f8d4a9f44e5bcde2e914b9443e4be2c1867f))
* **main:** release magento-log-viewer 1.27.0 ([#53](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/53)) ([7e52b03](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/7e52b03d34ea58d4149bc9a2f8c5ab126532a671))
* **main:** release magento-log-viewer 1.27.1 ([#70](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/70)) ([0de489a](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/0de489afe9efc8e24959946474ae8dc76dbce434))
* **main:** release magento-log-viewer 1.27.2 ([#73](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/73)) ([ce245f8](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/ce245f8eb3364e1da1b8040db091836b6f4ea600))
* **main:** release magento-log-viewer 1.28.0 ([#79](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/issues/79)) ([41aa4f8](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/41aa4f895b35e48b6f4edb9e2603b3d6fe326be3))
* **release:** update version to 1.18.1 and update changelog ([79f1c5f](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/79f1c5f44546b873ab502528029b4f6d86b6b1ed))
* **release:** Version auf 1.16.0 erhöhen & Changelog aktualisieren (2025-10-20) 🚀 ([c06e659](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/c06e65940cec083c66a59ad6b6003ff8a954972c))
* **release:** Version bump 1.17.0 ([b2e8183](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/b2e8183dfa41fc56b5a410d0d710fdb563c757d0))
* remove outdated guidelines from CHANGELOG.md ([035b89d](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/035b89dd46bfe58d7865ec707618a63f63d67492))
* remove vsce configuration to exclude .trunk/tools directory ([cdefc40](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/cdefc401513b7b9c36ae0370ef02e91b79880aef))
* update changelog and version to 1.2.2; fix code duplication and trailing comma ([0200e7b](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/0200e7b02e30f1246148c2ec259741cc72cddc1a))
* update changelog for version 1.2.1 and add Codacy badge to README ([678e4fd](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/678e4fdb928a320e67debee14affaa161a026888))
* update changelog for version 1.3.0; add video to README and group log entries feature ([eb403ca](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/eb403ca591ae61ac01b5463c05b27de626b3d0d1))
* update CHANGELOG for version 1.8.0 and remove unused command ([a0b2c86](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/a0b2c86e951030ccd6b7100b96faa9fb5ea7a4bf))
* update changelog formatting for clarity and organization ([8e77096](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/8e77096b8076ddc7edec051edbb70919ffc35cb4))
...
* update CHANGELOG.md for version 1.8.1; add sponsor link and install-counter ([8177b47](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/8177b4773566a0e800689b0d666be75d42994ae4))
* update CHANGELOG.md for version 1.8.3; improve project configuration handling and message display logic ([b12755e](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/b12755e7f6b4e0bcdc27f48014221c63a86e9857))
* update dependencies in package-lock.json ([55ad88d](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/55ad88d4458586d82ad971ec3a0784fce233ff91))
...
* update devDependencies and adjust versions in package.json ([a230865](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/a2308652266a7c8c451c25fb95a9c7964d02c88d))
* update license and dependencies in package-lock.json ([25ea8c5](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/25ea8c53b559c3b8c6a3199cad71765160541127))
...
* update release configuration for package name and header ([9cc7bde](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/9cc7bdead97213492c80739617eaad94226e8b85))
* update version to 1.10.0 in package.json ([6071618](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/6071618c330f079368e3afdbb7ea264df2d5e394))
* update version to 1.10.1 and fix update notification message ([d2c5035](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/d2c5035e441348dbf62f862af8c08173faf0363c))
* update version to 1.11.0 in package.json and reorganize changelog ([b1c0f21](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/b1c0f21ef374f11fb918dce2e5495e412c81e8a6))
* update version to 1.12.1 in package.json ([cc87590](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/cc87590f068c9db6238430b17753e243049a5c0e))
* update version to 1.23.0 and enhance changelog with new features and fixes ([66f9860](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/66f9860cbcbac8b61a5257a722b021d30aebc4e8))
* update version to 1.8.1 and add sponsor information in package.json; update README.md badge ([6a8b0a3](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/6a8b0a31f3b321abc02ebfded4985462cd2e72c5))
* update version to 1.8.2; modify prompt behavior to show Magento project confirmation only when a project is loaded ([71d5b36](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/71d5b36276fa0826bd8968164ccbb315da645781))
* update version to 1.9.0 and add keywords in package.json ([d701ceb](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/d701cebadee8e9ba92932ca4f5e7a8ed4cd5a207))
* update version to 1.9.0 in CHANGELOG.md ([3659bec](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/commit/3659becd28a2c348f224d02ba69992339a83c75b))
...
## [1.28.2](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/compare/v1.28.1...v1.28.2) (2026-04-14)
...
## [1.28.1](https://github.com/OpenForgeProject/vscode-ext-magento-log-viewer/compare/v1.28.0...v1.28.1) (2026-04-14)
